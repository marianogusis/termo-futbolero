...
function Resultado({ respuestas, onReiniciar }: any) {
  ...
  const SITE_URL = "https://que-tan-termo-sos.vercel.app";
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "24px 20px 60px", display: "flex", flexDirection: "column", alignItems: "center" }}>
      <div style={{ maxWidth: 440, width: "100%", transition: "opacity 0.6s ease, transform 0.6s ease", opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(24px)" }}>
        ...
        <p style={{ textAlign: "center", marginTop: 24, fontFamily: "var(--font-mono)", fontSize: 11, color: "#334155", letterSpacing: "0.1em" }}>
          ¿QUÉ TAN TERMO SOS?
        </p>
        <div style={{ textAlign: "center", marginTop: 20, paddingTop: 20, borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "#64748b", letterSpacing: "0.02em", marginBottom: 6, fontStyle: "italic" }}>
            Vamos por la cuarta 🏆
          </p>
          <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "#64748b", letterSpacing: "0.02em", fontStyle: "italic" }}>
            Elijo creer 🙏
          </p>
        </div>
      </div>
